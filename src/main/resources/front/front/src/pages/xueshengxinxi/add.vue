...
<div :style='{"border":"1px solid #dfdfdf","padding":"20px","margin":"20px auto 0","borderRadius":"16px","background":"#fff","width":"1200px","position":"relative"}'>
    ...
    >
          ...
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' label="床位号" prop="chuangweihao">
            <el-input v-model="ruleForm.chuangweihao" 
                placeholder="床位号" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' label="教师账号" prop="jiaoshizhanghao">
            <el-input v-model="ruleForm.jiaoshizhanghao" 
                placeholder="教师账号" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' label="教师姓名" prop="jiaoshixingming">
            <el-input v-model="ruleForm.jiaoshixingming" 
                placeholder="教师姓名" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' label="上次离开宿舍时间" prop="shangcilikaisusheshijian" >
              <el-date-picker
                  value-format="yyyy-MM-dd HH:mm:ss"
                  v-model="ruleForm.shangcilikaisusheshijian" 
                  type="datetime"
                  placeholder="上次离开宿舍时间">
              </el-date-picker>
          </el-form-item>
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' label="上次返回宿舍时间" prop="shangcifanhuisusheshijian" >
              <el-date-picker
                  value-format="yyyy-MM-dd HH:mm:ss"
                  v-model="ruleForm.shangcifanhuisusheshijian" 
                  type="datetime"
                  placeholder="上次返回宿舍时间">
              </el-date-picker>
          </el-form-item>
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' label="备注" prop="beizhu">
...
<script>
  export default {
    data() {
      return {
        ...
        ro:{
            ...
            shangcilikaisusheshijian : false,
            shangcifanhuisusheshijian : false,
            beizhu : false,
        ...
        ruleForm: {
          ...
          jiaoshizhanghao: '',
          jiaoshixingming: '',
          shangcilikaisusheshijian: '',
          shangcifanhuisusheshijian: '',
          beizhu: '',
          suguanzhanghao: '',
          suguanxingming: '',
        },
    ...
    created() {
      ...
      this.ruleForm.shangcilikaisusheshijian = this.getCurDateTime()
      this.ruleForm.shangcifanhuisusheshijian = this.getCurDateTime()
    },
    methods: {
      getMakeZero(s) {
          return s < 10 ? '0' + s : s;
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='shangcilikaisusheshijian'){
              this.ruleForm.shangcilikaisusheshijian = obj[o];
              this.ro.shangcilikaisusheshijian = true;
              continue;
            }
            if(o=='shangcifanhuisusheshijian'){
              this.ruleForm.shangcifanhuisusheshijian = obj[o];
              this.ro.shangcifanhuisusheshijian = true;
              continue;
            }
            if(o=='beizhu'){
      ...
      xuehaoChange () {
        this.$http.get('follow/xuesheng/xuehao?columnValue=' + this.ruleForm.xuehao, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            ...
            if(res.data.data.sushehao){
              this.ruleForm.sushehao = res.data.data.sushehao
            }
            if(res.data.data.chuangweihao){
              this.ruleForm.chuangweihao = res.data.data.chuangweihao
            }
            if(res.data.data.jiaoshizhanghao){
              this.ruleForm.jiaoshizhanghao = res.data.data.jiaoshizhanghao
            }
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('xueshengxinxi/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
        ...
        this.$refs["ruleForm"].validate(valid => {
          if(valid) {
            ...
            if(crossrefid && crossuserid) {
                 ...
                 this.$http.get('xueshengxinxi/list', {
                  params: params
                 }).then(res => {
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('xueshengxinxi/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '操作成功',
                                      type: 'success',
