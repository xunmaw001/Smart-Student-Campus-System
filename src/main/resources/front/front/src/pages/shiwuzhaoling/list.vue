...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto","order":"2"}'>
      ...
      <el-form-item :style='{"margin":"0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>拾得地址</div>
        <el-input v-model="formSearch.shidedizhi" placeholder="拾得地址" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"0 10px"}'>
	  ...
	  <el-button v-if="isAuth('shiwuzhaoling','新增')" :style='{"cursor":"pointer","border":"1px solid #db961f","padding":"0px 15px","boxShadow":"1px 1px 3px #f8a412","margin":"0px 10px 0 0","color":"#fff","outline":"none","borderRadius":"4px","background":"#f8a412","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}' type="primary" @click="add('/index/shiwuzhaolingAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
	...
	<div class="list" :style='{"width":"100%","margin":"0 0 10px","background":"none","order":"3"}'>
		...
		<div class="list1 index-pv1" :style='{"border":"1px solid #dfdfdf","padding":"20px 10px","margin":"16px 0 0 0","overflow":"hidden","borderRadius":"16px","flexWrap":"wrap","background":"#fff","display":"block","width":"1200px","height":"auto"}'>
			<div :style='{"margin":"0 1% 20px 1%","borderRadius":"8px","background":"none","display":"inline-block","width":"23%","position":"relative","float":"left","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				<img :style='{"cursor":"pointer","border":"1px solid #ddd","objectFit":"contain","borderRadius":"8px","background":"#fff","display":"block","width":"100%","height":"274px"}' v-if="item.wupintupian && item.wupintupian.substr(0,4)=='http'" :src="item.wupintupian" class="image" />
				<img :style='{"cursor":"pointer","border":"1px solid #ddd","objectFit":"contain","borderRadius":"8px","background":"#fff","display":"block","width":"100%","height":"274px"}' v-else :src="baseUrl + (item.wupintupian?item.wupintupian.split(',')[0]:'')" class="image" />
	...
	<div class="hot" :style='{"width":"100%","margin":"20px 0 0 0","borderRadius":"8px 8px 0 0","background":"none","height":"auto","order":"5"}'>
	  ...
	  <div :style='{"border":"1px solid #dfdfdf","padding":"20px","boxShadow":"1px 2px 3px #eee,inset 0px 16px 16px 0px #eee","borderRadius":"0 0 8px 8px","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
	    <div v-for="item in hotList" :key="item" :style='{"width":"23%","background":"#fff","height":"auto"}' @click="toDetail(item)">
	      <img :style='{"cursor":"pointer","border":"1px solid #ddd","objectFit":"contain","borderRadius":"8px","display":"block","width":"100%","height":"220px"}' v-if="item.wupintupian && item.wupintupian.substr(0,4)=='http'" :src="item.wupintupian" alt="">
	      <img :style='{"cursor":"pointer","border":"1px solid #ddd","objectFit":"contain","borderRadius":"8px","display":"block","width":"100%","height":"220px"}' v-else :src="baseUrl + (item.wupintupian?item.wupintupian.split(',')[0]:'')" alt="">
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.formSearch.shidedizhi != '') searchWhere.shidedizhi = '%' + this.formSearch.shidedizhi + '%';
        if (this.formSearch.xingming != '') searchWhere.xingming = '%' + this.formSearch.xingming + '%';
	      params['sfsh'] = '是';
        this.$http.get('shiwuzhaoling/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
