...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto","order":"2"}'>
      ...
      <el-form-item :style='{"margin":"0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>丢失地点</div>
        <el-input v-model="formSearch.diushididian" placeholder="丢失地点" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"0 10px"}'>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.formSearch.diushididian != '') searchWhere.diushididian = '%' + this.formSearch.diushididian + '%';
        if (this.formSearch.xingming != '') searchWhere.xingming = '%' + this.formSearch.xingming + '%';
	      params['sfsh'] = '是';
        this.$http.get('xunwuqishi/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
