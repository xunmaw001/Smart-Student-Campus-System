	...
	<div class="addEdit-block" :style='{"padding":"30px","background":"url(http://codegen.caihongy.cn/20220730/4b6f6d88fde34446904f3e1cd2807e39.png) center center/cover fixed no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="当前职位" prop="dangqianzhiwei">
					<el-select :disabled="ro.dangqianzhiwei" v-model="ruleForm.dangqianzhiwei" placeholder="请选择当前职位" >
						<el-option
							v-for="(item,index) in dangqianzhiweiOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="当前职位" prop="dangqianzhiwei">
					<el-input v-model="ruleForm.dangqianzhiwei"
						placeholder="当前职位" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="专业名称" prop="zhuanyemingcheng">
					<el-input v-model="ruleForm.zhuanyemingcheng" placeholder="专业名称" clearable  :readonly="ro.zhuanyemingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="专业名称" prop="zhuanyemingcheng">
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='dangqianzhiwei'){
							this.ruleForm.dangqianzhiwei = obj[o];
							this.ro.dangqianzhiwei = true;
							continue;
						}
