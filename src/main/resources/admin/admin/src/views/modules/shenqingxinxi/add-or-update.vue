	...
	<div class="addEdit-block" :style='{"padding":"30px","background":"url(http://codegen.caihongy.cn/20220730/4b6f6d88fde34446904f3e1cd2807e39.png) center center/cover fixed no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="进来时间" prop="jinlaishijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.jinlaishijian" 
						type="datetime"
						:readonly="ro.jinlaishijian"
						placeholder="进来时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jinlaishijian" label="进来时间" prop="jinlaishijian">
					<el-input v-model="ruleForm.jinlaishijian" placeholder="进来时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="停留时间" prop="tingliushijian">
					<el-input v-model="ruleForm.tingliushijian" placeholder="停留时间" clearable  :readonly="ro.tingliushijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="停留时间" prop="tingliushijian">
					<el-input v-model="ruleForm.tingliushijian" placeholder="停留时间" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="申请原因" prop="shenqingyuanyin">
					<el-input
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.shenqingyuanyin" label="申请原因" prop="shenqingyuanyin">
					<span :style='{"fontSize":"14px","lineHeight":"1.5","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.shenqingyuanyin}}</span>
				</el-form-item>
