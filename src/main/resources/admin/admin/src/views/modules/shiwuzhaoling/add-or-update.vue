	...
	<div class="addEdit-block" :style='{"padding":"30px","background":"url(http://codegen.caihongy.cn/20220730/4b6f6d88fde34446904f3e1cd2807e39.png) center center/cover fixed no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="拾得地址" prop="shidedizhi">
					<el-input v-model="ruleForm.shidedizhi" placeholder="拾得地址" clearable  :readonly="ro.shidedizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="拾得地址" prop="shidedizhi">
					<el-input v-model="ruleForm.shidedizhi" placeholder="拾得地址" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="拾得时间" prop="shideshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.shideshijian" label="拾得时间" prop="shideshijian">
					<el-input v-model="ruleForm.shideshijian" placeholder="拾得时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="认领地址" prop="renlingdizhi">
					<el-input v-model="ruleForm.renlingdizhi" placeholder="认领地址" clearable  :readonly="ro.renlingdizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="认领地址" prop="renlingdizhi">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="物品描述" prop="wupinmiaoshu">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.wupinmiaoshu" label="物品描述" prop="wupinmiaoshu">
                    <span :style='{"fontSize":"14px","lineHeight":"1.5","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.wupinmiaoshu"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.wupinmiaoshu = this.ruleForm.wupinmiaoshu.replace(reg,'../../../springbootggr80/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
