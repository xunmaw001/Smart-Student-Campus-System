	...
	<div class="addEdit-block" :style='{"padding":"30px","background":"url(http://codegen.caihongy.cn/20220730/4b6f6d88fde34446904f3e1cd2807e39.png) center center/cover fixed no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="卫生情况" prop="weishengqingkuang">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="卫生情况" prop="weishengqingkuang">
					<el-input v-model="ruleForm.weishengqingkuang"
						placeholder="卫生情况" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="评分" prop="pingfen">
					<el-input v-model="ruleForm.pingfen" placeholder="评分" clearable  :readonly="ro.pingfen"></el-input>
				</el-form-item>
