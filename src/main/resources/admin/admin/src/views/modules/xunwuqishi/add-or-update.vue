	...
	<div class="addEdit-block" :style='{"padding":"30px","background":"url(http://codegen.caihongy.cn/20220730/4b6f6d88fde34446904f3e1cd2807e39.png) center center/cover fixed no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="物品名称" prop="wupinmingcheng">
					<el-input v-model="ruleForm.wupinmingcheng" placeholder="物品名称" clearable  :readonly="ro.wupinmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="物品名称" prop="wupinmingcheng">
					<el-input v-model="ruleForm.wupinmingcheng" placeholder="物品名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.wupintupian" label="物品图片" prop="wupintupian">
					<file-upload
						tip="点击上传物品图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.wupintupian" label="物品图片" prop="wupintupian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="丢失地点" prop="diushididian">
					<el-input v-model="ruleForm.diushididian" placeholder="丢失地点" clearable  :readonly="ro.diushididian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="丢失地点" prop="diushididian">
					<el-input v-model="ruleForm.diushididian" placeholder="丢失地点" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="丢失时间" prop="diushishijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.diushishijian" 
						type="datetime"
						:readonly="ro.diushishijian"
						placeholder="丢失时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.diushishijian" label="丢失时间" prop="diushishijian">
					<el-input v-model="ruleForm.diushishijian" placeholder="丢失时间" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="详细描述" prop="xiangximiaoshu">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.xiangximiaoshu" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.xiangximiaoshu" label="详细描述" prop="xiangximiaoshu">
                    <span :style='{"fontSize":"14px","lineHeight":"1.5","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.xiangximiaoshu"></span>
                </el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.diushishijian = this.getCurDateTime()
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='diushishijian'){
							this.ruleForm.diushishijian = obj[o];
							this.ro.diushishijian = true;
							continue;
						}
						if(o=='xiangximiaoshu'){
							this.ruleForm.xiangximiaoshu = obj[o];
							this.ro.xiangximiaoshu = true;
							continue;
						}
						if(o=='fabushijian'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.xiangximiaoshu = this.ruleForm.xiangximiaoshu.replace(reg,'../../../springbootggr80/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xunwuqishi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xunwuqishiCrossAddOrUpdateFlag = false;
						 this.parent.search();
