...
public interface WeixiurenyuanService extends IService<WeixiurenyuanEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<WeixiurenyuanEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<WeixiurenyuanEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<WeixiurenyuanEntity> wrapper);
