...
public class XueshengController {
    ...
    public R page(@RequestParam Map<String, Object> params,XueshengEntity xuesheng,
		...
		if(tableName.equals("jiaoshi")) {
			xuesheng.setJiaoshizhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("suguan")) {
			xuesheng.setSuguanzhanghao((String)request.getSession().getAttribute("username"));
		}
        ...
        try {
            ...
            if(rows>1){
                ...
                for (int i = 1; i < rows; i++) {
                    ...
                    xueshengEntity.setSushehao(sushehao);
                    String chuangweihao = CommonUtil.getCellValue(row.getCell(7));
                    xueshengEntity.setChuangweihao(chuangweihao);
                    String jiaoshizhanghao = CommonUtil.getCellValue(row.getCell(8));
                    xueshengEntity.setJiaoshizhanghao(jiaoshizhanghao);
                    String jiaoshixingming = CommonUtil.getCellValue(row.getCell(9));
                    xueshengEntity.setJiaoshixingming(jiaoshixingming);
                    String suguanzhanghao = CommonUtil.getCellValue(row.getCell(10));
                    xueshengEntity.setSuguanzhanghao(suguanzhanghao);
                    String suguanxingming = CommonUtil.getCellValue(row.getCell(11));
                    xueshengEntity.setSuguanxingming(suguanxingming);
