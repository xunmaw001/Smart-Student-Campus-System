...
public class XueshengxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,XueshengxinxiEntity xueshengxinxi,
		...
		if(tableName.equals("xuesheng")) {
			xueshengxinxi.setXuehao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("jiaoshi")) {
			xueshengxinxi.setJiaoshizhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("suguan")) {
			xueshengxinxi.setSuguanzhanghao((String)request.getSession().getAttribute("username"));
		}
