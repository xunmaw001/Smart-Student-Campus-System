...
public class XueshengjinchususheEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public XueshengjinchususheEntity() {
		
	}
	
	public XueshengjinchususheEntity(T t) {
		try {
	 ...
	 * 设置：口令码
	 */
	public void setKoulingma(Double koulingma) {
		this.koulingma = koulingma;
	}
	/**
	 * 获取：口令码
	 */
	public Double getKoulingma() {
		return koulingma;
	}
	/**
	 * 设置：登记时间
