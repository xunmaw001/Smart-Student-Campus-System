...
public class XueshengbaoxiuEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public XueshengbaoxiuEntity() {
		
	}
	
	public XueshengbaoxiuEntity(T t) {
		try {
	 ...
	 * 设置：问题简述
	 */
	public void setWentijianshu(String wentijianshu) {
		this.wentijianshu = wentijianshu;
	}
	/**
	 * 获取：问题简述
	 */
	public String getWentijianshu() {
		return wentijianshu;
	}
	/**
	 * 设置：报修日期
