...
public class XueshengxinxiVO  implements Serializable {
	...
	@DateTimeFormat 
	private Date shangcilikaisusheshijian;
	...
	@JsonFormat(locale="zh", timezone="GMT+8", pattern="yyyy-MM-dd HH:mm:ss")
	@DateTimeFormat 
	private Date shangcifanhuisusheshijian;
	...
	public void setShangcilikaisusheshijian(Date shangcilikaisusheshijian) {
		this.shangcilikaisusheshijian = shangcilikaisusheshijian;
	}
	
	/**
	 * 获取：上次离开宿舍时间
	 */
	public Date getShangcilikaisusheshijian() {
		return shangcilikaisusheshijian;
	}
	...
	public void setShangcifanhuisusheshijian(Date shangcifanhuisusheshijian) {
		this.shangcifanhuisusheshijian = shangcifanhuisusheshijian;
	}
	
	/**
	 * 获取：上次返回宿舍时间
	 */
	public Date getShangcifanhuisusheshijian() {
		return shangcifanhuisusheshijian;
	}
